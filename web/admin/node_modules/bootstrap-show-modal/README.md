...
Use `classTrue` and `classFalse` to customize the button classes, for example a red
confirm button for a destructive action. They default to `"btn btn-primary"` and
`"btn btn-secondary"`.
